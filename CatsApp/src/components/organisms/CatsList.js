                ...
                children={
                    <View key={item.id} style={styles.childrenStyle}>
                        ...
                        <ImageBackground key={item.image?.id} source={{ uri: item.image?.url }} style={styles.imageBackgroundStyle} >
                            ...
                            <MaterialCommunityIcons name={isCollapse && indexSelected == index ? 'arrow-collapse-up' : 'arrow-collapse-down'} style={{ alignSelf: 'center', fontSize: fonts.size.font18, color: colors.white }} />
                        </ImageBackground>
                        {
...
const styles = StyleSheet.create({
    ...
    imageBackgroundStyle: {
        resizeMode: 'cover',
        height: metrics.screenHeight / 3.8,
        width: 'auto',
